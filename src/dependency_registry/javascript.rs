...
pub struct JavascriptDependencyRegistryData {
    ...
    pub(crate) default: JavascriptDependencyTargetData,
    ...
    pub(crate) dependencies: HashMap<String, JavascriptDependencyData>,
}

#[derive(Deserialize, Default, Clone, Debug)]
pub struct JavascriptDependencyData {
    #[serde(flatten)]
    pub(crate) default: JavascriptDependencyTargetData,
    // Keep the key a `String` since users can make custom targets.
    #[serde(default)]
    pub(crate) targets: HashMap<String, JavascriptDependencyTargetData>,
}

impl JavascriptDependencyData {
...
impl DevEnvironmentAppliable for JavascriptDependencyData {
    #[tracing::instrument(skip_all)]
...
#[derive(Deserialize, Default, Clone, Debug)]
pub struct JavascriptDependencyTargetData {
...
impl DevEnvironmentAppliable for JavascriptDependencyTargetData {
    #[tracing::instrument(skip_all)]
    fn apply(&self, dev_env: &mut DevEnvironment) {
...
mod test {
    ...
    async fn try_apply() -> eyre::Result<()> {
        ...
        let target = format!("{}", target_lexicon::HOST);
        let data = JavascriptDependencyData {
            default: JavascriptDependencyTargetData {
            ...
            targets: {
                ...
                map.insert(
                    target,
                    JavascriptDependencyTargetData {
